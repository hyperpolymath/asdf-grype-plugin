...
;; STATE.scm - Project state tracking for asdf-grype-plugin
;; Media-Type: application/vnd.state+scm

(define-state asdf-grype-plugin
  (metadata
    (version "0.1.0")
    (schema-version "1.0.0")
    (created "2026-01-30")
    (updated "2026-01-30")
    (project "asdf-grype-plugin")
    (repo "hyperpolymath/asdf-grype-plugin"))

  (project-context
    (name "asdf-grype-plugin")
